...
def populate_payroll_list_sheet(ws):
    ...
    return (
        ...
        f"N{total_yearly_million_1403_idx}",
        f"AC{total_yearly_million_1402_idx}",
        f"V{total_yearly_million_1403_idx}",
        f"AK{total_yearly_million_1402_idx}"
    )
...
def main_model_execution():
    ...
    populate_equity_sheet(ws_equity, assumption_map)
    ...
    # 9. جریان های نقدی (برای استفاده در ترازنامه)
    ...
    # 10. وضعیت مالی (ترازنامه) - این باید بعد از تمامی شیت‌های وابسته پر شود
    ...
    for i in range(num_iterations):
        ...
        populate_equity_sheet(wb['حقوق مالکانه'])
